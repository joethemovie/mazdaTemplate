        ...
        <div class="row">
            ...
            <table width="870px">
              ...
              <tr>
                  ...
                  <td>
                    <input type="checkbox" id="dayOne" name="dayOne" value="on"><span class="transText"> Day One</span>
                  </td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td><input id="cvt" type="radio" name="transmission" value=" Automatic CVT"> <span class="transText">Automatic CVT</span><br>
